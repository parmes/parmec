# PARMEC test --> SPRING contact test
...
SPRING (parnum, (1, 0, 1), -1, (1, 0, 0), spring, dashpot, direction=(0, 0, 1))
SPRING (parnum, (1, 1, 1), -1, (1, 1, 0), spring, dashpot, direction=(0, 0, 1))
SPRING (parnum, (0, 1, 1), -1, (0, 1, 0), spring, dashpot, direction=(0, 0, 1))
